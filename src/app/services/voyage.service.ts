...
export class VoyageService {
  private Voyage: Voyage[]=[
    ...
    'assets/Hokkaido.jfif','10 jours',new Date(1/12/2022),new Date(11/12/2022),false,0),
    ...
    ,'10 jours',new Date(1/12/2022),new Date(11/12/2022),false,0),
    ...
    'assets/kanto.jpg','10 jours',new Date(1/12/2022),new Date(11/12/2022),false,0),
    new Voyage (5, 'Tokai', 6000, 'la région du Tokai offre à la fois des destinations de renommée mondiale et des trésors méconnus',
    'assets/Tokai.jpg','10 jours',new Date(1/12/2022),new Date(11/12/2022),false,0),
    ...
    new Date(14/1/2021),new Date(19/1/2022),true,25),
    ...
    new Date(17/2/2021),new Date(20/2/2022),true,2),
    ...
    new Date(17/2/2021),new Date(20/2/2022),false,0),
